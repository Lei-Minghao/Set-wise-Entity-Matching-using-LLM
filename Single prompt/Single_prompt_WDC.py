...
DATASET_PATH      = "./dataset/sample_dataset_1.csv"
GROUND_TRUTH_PATH = "./dataset/sample_dataset_1_gt.csv"

# Fields to use for entity matching
MATCHING_FIELDS = ['brand', 'title', 'description', 'price', 'priceCurrency']
...
def main():
    ...
    output_path  = f"./Single prompt/results/{dataset_name}_single_prompt_sample_1_Summary.txt"
