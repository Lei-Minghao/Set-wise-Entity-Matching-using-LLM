...
from comparing_qwen_WDC import ComparingSQ
from matching_qwen_WDC import MatchingSQ
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default="./CoMEM/data/sample_solut_top30.csv") # <-- CHANGE THIS TO YOUR CSV
    ...
    output_file = f"./CoMEM/data/qwen_rankings_{args.strategy}_WDC.json"
