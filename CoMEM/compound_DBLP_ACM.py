...
if __name__ == "__main__":
    ...
    parser.add_argument("--ranking_file", type=str, default="./CoMEM/data/qwen_rankings_matching_DBLP_ACM.json")
    parser.add_argument("--selecting-model", type=str, default=os.environ.get("GEMINI_MODEL", ""))
    parser.add_argument("--output", type=str, default="./CoMEM/results/compound_results_DBLP_ACM.txt")
    ...
    # Target dataset
    dataset_files = [Path("./CoMEM/data/sample_DBLP_ACM_top5.csv")]
