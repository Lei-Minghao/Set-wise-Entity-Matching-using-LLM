...
if __name__ == "__main__":
    ...
    parser.add_argument("--ranking_file", type=str, default="./CoMEM/data/qwen_rankings_matching_WDC.json")
    parser.add_argument("--selecting-model", type=str, default=os.environ.get("GEMINI_MODEL", ""))
    parser.add_argument("--output", type=str, default="./CoMEM/results/compound_results_WDC.txt")
