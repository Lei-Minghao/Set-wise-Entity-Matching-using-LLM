...
from comparing_qwen_walmart_amazon import ComparingSQ
from matching_qwen_walmart_amazon import MatchingSQ
    ...
    return [
        {
            ...
            "candidate_ids": v["id_right"]  # Tracks alphanumeric IDs (e.g., amazon_17892)
        } 
...
if __name__ == "__main__":
    ...
    dataset_files = [Path("./CoMEM/data/sample_walmart_amazon_top5.csv")] # <-- CHANGE THIS TO YOUR CSV
    all_rankings = {}
    ...
    for file in dataset_files:
        ...
        for instance in tqdm(instances, desc="Ranking Instances"):
            if args.strategy == "matching":
                # MatchingSQ now directly returns the list of string IDs
    ...
    output_file = f"./CoMEM/data/qwen_rankings_{args.strategy}_walmart_amazon.json"
